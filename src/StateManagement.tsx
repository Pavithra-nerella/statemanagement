      ...
      <Table sx={{ width: "100%" }} aria-label="candidates table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="center" width="78px">
              STATUS
            </TableCell>
            <TableCell align="center" width="75px">
              LOCATION
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.id}>
              ...
              <TableCell
                align="center"
                onClick={(event) => handleCellClick(row.id)}
              >
                <Button size="small">ENGAGE</Button>
              </TableCell>
              <TableCell
                align="center"
                onClick={(event) => handleCellClick2(row.id)}
              >
                <Button size="small">CONSIDER</Button>
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
